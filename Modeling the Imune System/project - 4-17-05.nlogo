...
to setup-globals
  ...
  set initial-white-cell 100;(initial-red-cell / 500) ;the number of white blood cells equals red-cells/500 from research
...
to setup-white-cell
    create-custom-white-cell initial-white-cell [set shape "whiteblood" set color white set heading 360]
...
to setup-red-cell
  create-custom-red-cell initial-red-cell [set shape "redblood" set color orange set heading 360  ]
  ask red-cell [if random 2 = 0[(set xcor random skin-bound-right + 1) (set ycor random screen-size-y)]
                if random 2 = 1[(set xcor (- random skin-bound-right - 1)) (set ycor random screen-size-y)]]
end

;to setup-nutrients
;  let n 0 
;  repeat (skin-bound-right - skin-thickness) [ask patches [if 
;end
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to go-red-cell
  ask red-cell [fd (random 20) * .1]
                ;ifelse xcor <= skin-bound-left [set heading heading ] [fd 1 set heading heading + (random 2)]
end
