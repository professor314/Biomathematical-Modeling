...
turtles-own [ ;used for all breeds (some of these variables are only for a certain type of breed
  ...
  resources                ;used for red blood cells
]
...
to setup-white-cell
    create-custom-white-cell initial-white-cell [set shape "whiteblood" set color white ifelse random 2 = 1 [set out-of-body? false set heading (360 - random 10)][set heading (360 + random 10)]] ;set headings to be mostly forward but having some small component in the x or -x direction]
...
to setup-red-cell
  create-custom-red-cell initial-red-cell [set shape "redblood" set color orange ifelse random 2 = 1 [set out-of-body? false set heading (360 - random 10)][set heading (360 + random 10)]] ;set headings to be mostly forward but having some small component in the x or -x direction
...
to find-virus
 ask white-cell [ifelse any? virus in-radius blood-sensing-radius [
