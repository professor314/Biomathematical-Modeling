...
if flesh?-of patch-here = true and wandering? [set wandering? false set hatch-count-down virus-hatch-rate]
    if hatch-count-down = 0 [hatch 3[set wandering? true set hatch-count-down virus-hatch-rate] set wandering? true]
end
...
to collect-oxygen ;called in red-cell-go procedure
  ask red-cell [if oxygen?-of patch-here and oxygen-amount < 10 [set oxygen-amount oxygen-amount]
end
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
