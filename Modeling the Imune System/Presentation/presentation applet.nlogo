...
ask B-cell [if flowing?[
  ...
  ask B-cell[set hatch-count-down hatch-count-down - 1
    ...
    let x 0
    let y 0
    if count virus-near != 0 and hatch-count-down <= 0 [hatch-antibodies 1[set color yellow set wandering? true set hatch-count-down 10 set xcor (xcor + random 3) set ycor (ycor + random 3)]
